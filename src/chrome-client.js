...
function setLayoutGateCard(state) {
  ...
  layoutGateCopy.textContent = "ZILO Plan Editor is waiting for fonts and final geometry before revealing this artifact.";
}
...
function forceRevealLayoutGate(reason) {
  ...
  const bannerText =
    reason === "timeout"
      ? "This surface may have layout issues. ZILO Plan Editor revealed it after the safety timeout so review is never blocked."
