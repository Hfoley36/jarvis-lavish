...
export function createDesignOutput() {
  return {
    ...
    theme_usage: [
      'Default to using the ZILO design system (#277B65 primary, #151A21 background, #3A9A7A accent, Inter fonts). Use CSS variables: --zilo-primary: #277B65; --zilo-bg: #151A21; --zilo-accent: #3A9A7A; --zilo-text: #E2E8F0; --zilo-font: Inter, ui-sans-serif, system-ui, sans-serif. Pick a different theme from the list below only when the user asked for one or the content clearly calls for it.',
